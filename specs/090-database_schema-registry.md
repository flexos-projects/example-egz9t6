...
**DEPRECATION NOTICE:** This document defines a SQL-based schema. The project has moved to a Git-based content model using Astro Content Collections. The authoritative schema is now defined in `builds/001/specs/006-src-content-config-ts.md`. This file is kept for historical reference only.
